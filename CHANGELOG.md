...
### Changed
- **Categories**: Renamed the "Family" age group to "Adult" across the UI, export functionality, and documentation.
- **Data Persistence**: Implemented migration to automatically port existing "Family" counts to the new "Adult" category.
